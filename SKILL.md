...
- **Empty results** can mean an index hasn't been built yet (`semhood index .`), or the dimension changed (delete `qdrant_data/` and re-index), or the query is too short. Try a longer phrase before assuming nothing exists.
